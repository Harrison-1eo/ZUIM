<template>
    <div class="chat-input">
        <el-input v-model="newMessage" type="textarea" placeholder="输入消息..." resize="none" class="message-input"
            :rows="4" @keyup.enter="sendMessage()" />
        ...
        <div class="send-buttons">
            <div class="upload-icon-box">
                ...
                <div class="upload-icon">
                    ...
                    <input ref="imageInput" type="file" style="display: none" accept="image/*"
                ...
                if (response.data.code === 0) {
                    ...
                    if (type === 'file') {
                        this.$emit(
                            ...
                            ' you can download the file on http://localhost:8000' +
